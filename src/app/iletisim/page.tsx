  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2">
        <a
          href="mailto:destek@hesaplamamerkezi.com"
        ...
        >
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-text-muted">destek@hesaplamamerkezi.com</p>
            <p className="mt-2 text-xs text-text-muted">Reklam işbirlikleri, kurumsal talepler ve genel sorular.</p>
          </div>
        </a>

        <a
          href="mailto:hata@hesaplamamerkezi.com"
          className="card group flex items-start gap-4 p-5 transition-colors hover:border-primary/40"
        >
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-text-muted">hata@hesaplamamerkezi.com</p>
        ...
        <a
          href="mailto:oneri@hesaplamamerkezi.com"
        ...
        >
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-text-muted">oneri@hesaplamamerkezi.com</p>
            <p className="mt-2 text-xs text-text-muted">
