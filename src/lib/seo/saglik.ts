...
export const saglikContent: Record<string, SeoExtra> = {
  ...
  "vucut-yag-orani": {
    ...
    detay: [
      "Ölçümü her zaman aynı saatte (tercihen sabah, aç karnına) yapmak, gün içi su tutma ve şişkinlik dalgalanmalarından kaynaklanan yanıltıcı farkları önler — akşam yapılan ölçüm, aynı gün sabahki ölçüme göre bel çevresinde 1-2 cm'lik yapay bir artış gösterebilir.",
    ],
  },
  "su-ihtiyaci": {
    howItWorks: [
  ...
  "bel-kalca-orani": {
    ...
    detay: [
      "Aynı toplam yağ oranına sahip iki kişi, yağın vücutta dağılım şekli farklı olduğu için tamamen farklı sağlık riski taşıyabilir — bu yüzden WHR, özellikle görünüşte 'normal kilolu' ama karın çevresi geniş olan kişilerde BMI'nin gözden kaçırdığı riski ortaya çıkarır.",
    ],
  },
  "bel-boy-orani": {
    faqs: [
    ...
    detay: [
      "'Belin boyunun yarısını geçmesin' kuralı, farklı yaş ve etnik gruplarda BMI'ya göre daha tutarlı çalıştığı için bazı araştırmacılar tarafından tarama testi olarak tercih edilir — yaşlanmayla boy kısaldığı için (ortalama her 10 yılda ~1 cm) bu oranı zaman içinde yeniden hesaplamak gerekir.",
    ],
  },
  "bmi-hizli": {
    faqs: [
    ...
    detay: [
      "Boy karesiyle bölme, kısa boylu insanlarda BMI'yı hafifçe olduğundan yüksek, uzun boylularda hafifçe düşük gösterme eğilimindedir çünkü vücut kütlesi gerçekte boyun küpüyle değil karesiyle orantılı büyümez — bu istatistiksel yanlılık normal boy aralığında (155-190 cm) küçük kalır ama uç boylarda belirginleşir.",
    ],
  },
  "bmr-harris-benedict": {
    howItWorks: [
    ...
    detay: [
      "Aktivite katsayısını seçerken çoğu insan kendi aktivite düzeyini olduğundan yüksek tahmin eder — masa başı çalışıp haftada 3 gün spor yapan biri genellikle 'çok aktif' değil 'hafif aktif' kategorisine girer; katsayıyı yanlış seçmek TDEE'yi 300-500 kcal yanlış hesaplatıp kilo verme/alma planını baştan bozabilir.",
    ],
  },
  "ideal-kilo-bmi22": {
    faqs: [
    ...
    detay: [
      "Bu hesap tek bir hedef sayı verir ama gerçekte sağlıklı aralık BMI 18,5-24,9'un tamamını kapsar — 22'yi 'ulaşılması gereken tek doğru kilo' olarak görmek yerine, mevcut kilonuz zaten bu aralıktaysa büyük bir değişikliğe gerek olmadığını hatırlamak daha sağlıklı bir bakış açısıdır.",
    ],
  },
  "ilac-katilim-payi": {
    faqs: [
    ...
    detay: [
      "Reçetede birden fazla ilaç varsa katılım payı her ilaç için ayrı ayrı değil, kutu/kalem başına hesaplanır — 5 farklı ilaç yazılan bir reçetede toplam ödeme, her kaleminizin kendi kutu fiyatı ve katılım oranına göre ayrı ayrı toplanarak oluşur; eczanedeki tutar tek bir orandan hesaplanmış gibi görünse de aslında kalemlerin toplamıdır.",
    ],
  },
  "kalp-atis-zonlari": {
    howItWorks: [
    ...
    detay: [
      "220 − yaş formülü gerçekte oldukça kaba bir tahmindir ve aynı yaştaki iki kişide gerçek maksimum kalp atış hızı 10-20 vuru farklı çıkabilir — profesyonel antrenman planlarken laboratuvar testiyle ölçülen gerçek Max KAH kullanmak, formülle tahmin edilenden daha güvenilir zon sınırları verir.",
    ],
  },
  "kolesterol-kategori": {
    faqs: [
    ...
    detay: [
      "Toplam kolesterol tek başına yeterli bir gösterge değildir — toplam kolesterolü düşük ama LDL/HDL oranı bozuk olan biri, toplamı yüksek ama HDL'si güçlü olan birinden daha riskli sayılabilir; tahlil sonucunu okurken tek satıra değil, alt kalemlerin birbirine oranına bakmak gerekir.",
    ],
  },
  "kosu-tempo": {
    faqs: [
    ...
    detay: [
      "Koşu bantlarında hız km/s cinsinden gösterilirken açık hava koşucuları genelde tempo (dk/km) düşünür — iki birim ters orantılıdır ve bu yüzden 'daha büyük hız = daha küçük tempo' ilişkisini kafada tutmak, bant hızını ayarlarken hedef temponuzu tutturmanızı kolaylaştırır.",
    ],
  },
  "alkol-promil": {
    faqs: [
    ...
    detay: [
      "Aynı miktar alkolü tüketen iki kişinin promil değeri, yalnızca kiloya değil vücut yağ oranına da bağlıdır çünkü alkol yağ dokusunda değil vücut suyunda dağılır — bu yüzden aynı kiloda ama yağ oranı farklı iki kişide (r katsayısı farklı olduğundan) hesaplanan promil de farklı çıkar; formül bir tahmindir, kesin bir alkolmetre ölçümü değildir.",
    ],
  },
  "sigara-birakma": {
    faqs: [
    ...
    detay: [
      "İlk 72 saat fiziksel bağımlılık açısından en zorlu dönemdir çünkü nikotin yarılanma ömrü kısadır ve vücut hızla temizler — bu ilk üç günü atlatabilenlerin uzun vadeli başarı oranı belirgin yükselir; bu yüzden çoğu destek programı ilk hafta için yoğun takip önerir.",
    ],
  },
  "su-rehberi": {
    faqs: [
    ...
    detay: [
      "İdrar renginin açık sarı olması, susuzluk hissini beklemekten daha güvenilir bir gösterge kabul edilir — susama hissi vücut zaten az miktarda susuz kaldıktan sonra tetiklenir, özellikle yaşlılarda bu mekanizma zayıfladığından renk kontrolü daha erken uyarı verir.",
    ],
  },
  "tansiyon-kategori": {
    faqs: [
    ...
    detay: [
      "'Beyaz önlük sendromu' olarak bilinen bir olgu var — birçok kişi doktor muayenehanesinde stres nedeniyle evdekinden belirgin yüksek tansiyon ölçümü gösterir; bu yüzden tek seferlik klinik ölçümle tanı koymak yerine evde farklı günlerde tekrarlanan ölçümlerin ortalaması daha güvenilir kabul edilir.",
    ],
  },
  "uyku-dongu": {
    howItWorks: [
    ...
    detay: [
      "Uykuya dalmak genellikle sanıldığı gibi anlık değildir — ortalama bir yetişkinde 10-20 dakika sürer; bu araç yatış saatlerini hesaplarken bu süreyi otomatik ekler, yoksa hesaplanan saatler döngü sonuna denk gelmez ve alarm yine döngü ortasında çalabilir.",
    ],
  },
  vo2max: {
    faqs: [
    ...
    detay: [
      "12 dakikalık testte motivasyon ve pacing (hız dağıtımı) sonucu belirgin etkiler — ilk dakikalarda çok hızlı başlayıp sonradan yavaşlayan bir koşucu, testi baştan sona dengeli koşan aynı kondisyondaki birine göre daha düşük mesafe ve dolayısıyla düşük VO2 max tahmini alır; testi tekrarlarken tempo tutarlılığı sonuçların karşılaştırılabilir olması için önemlidir.",
    ],
  },
  "yasam-beklentisi": {
    faqs: [
    ...
    detay: [
      "Bir yaşa ulaşmış olmak, o yaştan sonraki beklentiyi otomatik olarak yükseltir çünkü doğuştaki ortalama, bebek ve çocukluk dönemi ölümlerini de içerir — 65 yaşındaki birinin kalan beklenen yaşam süresi, doğuştaki genel ortalamadan çıkarılan basit bir çıkarma işlemiyle bulunamaz, istatistiksel olarak daha yüksektir.",
    ],
  },
  "yuruyus-kalori": {
    faqs: [
    ...
    detay: [
      "Eğimli yürüyüş (rampa veya merdiven) düz zemine göre aynı sürede belirgin daha fazla kalori yaktırır çünkü yer çekimine karşı ekstra iş yapılır — koşu bandında %5-10 eğim eklemek, hızı artırmadan yakımı %30-50 artırabilir; eklem yükü düşük bir seçenek arayanlar için etkili bir alternatiftir.",
    ],
  },
  "zayiflama-sure": {
    howItWorks: [
    ...
    detay: [
      "7.700 kcal/kg değeri saf yağ dokusu için geçerlidir ama gerçek kilo kaybının bir kısmı su ve az miktarda kas kütlesinden gelir — özellikle diyetin ilk haftasında hızlı düşen kilonun büyük kısmı glikojenle birlikte tutulan sudur, bu yüzden ilk hafta kaybı sonraki haftalardan sistemli olarak daha hızlı görünür.",
    ],
  },
  "adet-takvimi": {
    faqs: [
    ...
    detay: [
      "Döngü uzunluğu değişkense (örneğin bazı aylar 26, bazı aylar 32 gün), tahmin ortalamaya dayandığından o ay için birkaç günlük sapma normal karşılanmalıdır — takvim uygulamalarının 'kesin tarih' gibi gösterdiği tahminler aslında istatistiksel bir orta noktadır, garanti değildir.",
    ],
  },
  "alkol-kalori": {
    faqs: [
    ...
    detay: [
      "Kokteyl ve şekerli likörlerin kalorisi genellikle iki kaynaktan gelir — hem alkolün kendisi hem de eklenen şurup/meyve suyu; bu yüzden aynı hacimdeki bir kokteyl, sade bir viski-sodadan 2-3 kat fazla kalori içerebilir, kalorinin tamamının alkolden geldiğini varsaymak yaygın bir yanılgıdır.",
    ],
  },
  "kek-kalori": {
    faqs: [
    ...
    detay: [
      "Dilim sayısı öznel bir seçimdir ve tarif etiketleri bunu genellikle küçük göstererek dilim başı kaloriyi düşük gösterir — üretici '12 dilim' varsayarken siz keki 8 parçaya kestiğinizde her diliminiz etiket değerinden %50 daha fazla kaloriye sahiptir.",
    ],
  },
  "merdiven-kalori": {
    faqs: [
    ...
    detay: [
      "Merdiven çıkma, aynı sürede yürüyüşten belirgin daha yoğun bir aktivitedir çünkü vücut ağırlığınızı düşey olarak da kaldırırsınız — kısa süreli olsa da bu tür 'mikro-egzersizlerin' gün içine dağıtılması, tek uzun bir antrenman seansına göre bazı çalışmalarda benzer toplam kalori yakımı sağlayabilir.",
    ],
  },
  "ovulasyon-takibi": {
    howItWorks: [
    ...
    detay: [
      "Formülün dayandığı varsayım, luteal fazın (ovulasyon-adet arası) 14 gün sabit olduğudur — gerçekte bu süre 10-16 gün arasında değişebilir ve değişkenlik asıl olarak döngünün ilk yarısında (folikül fazında) yaşanır; bu yüzden düzensiz döngüsü olan kadınlarda takvim tahmini, düzenli döngüsü olanlara göre çok daha büyük hata payı taşır.",
    ],
  },
  ...
  "asi-takvimi": {
    ...
    detay: [
      "Aşı takvimindeki tarihler 'en erken yapılabilecek' tarihlerdir, birkaç günlük gecikme aşının etkinliğini düşürmez — asıl önemli olan dozlar arasındaki minimum aralığın (genellikle 4 hafta) korunmasıdır; bu yüzden aile sağlığı merkezinizin randevu yoğunluğuna göre birkaç gün ileri alınan bir aşı endişe kaynağı olmamalıdır.",
    ],
  },
  "bebek-buyume-takibi": {
    faqs: [
    ...
    detay: [
      "Bebeğin persentil eğrisinde ani bir sıçrama veya düşüş (örneğin 50.'den 15.'e inmek), tek bir zayıf ölçümden kaynaklanabilir — hasta olduğu bir günde tartılan bebek gerçek eğrisinden sapmış görünebilir; hekimler genellikle art arda birkaç ölçümdeki eğilime bakar, tek bir noktaya değil.",
    ],
  },
  "bebek-uyku-ihtiyaci": {
    faqs: [
    ...
    detay: [
      "Yorgunluğu artan bir bebek, sanılanın aksine daha kolay değil daha zor uyuyabilir çünkü aşırı yorgunlukta vücut stres hormonu (kortizol) salgılayarak uyanık kalmaya çalışır — bu yüzden 'bebek daha az uyusun ki gece iyi uyusun' mantığı çoğu zaman tam tersi sonuç verir, uyku ihtiyacını erken karşılamak gece uykusunu da kolaylaştırır.",
    ],
  },
  "cocuk-boy-tahmini": {
    faqs: [
    ...
    detay: [
      "Mid-parental formülün ürettiği aralık çocuğun ergenlik öncesi persentiliyle birlikte değerlendirildiğinde daha anlamlı hale gelir — eğer çocuk kendi yaş grubunda sürekli üst persentillerde seyrediyorsa, formülün ürettiği ortalamadan daha yüksek bir boya ulaşması genellikle beklenen bir durumdur.",
    ],
  },
};
